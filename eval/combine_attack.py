...
parser.add_argument(
    "--perturbation", default="mixed", type=str, help="perturbation method"
)
parser.add_argument(
    "--distribution", default="uniform", type=str, help="distribution of perturbation"
)
parser.add_argument(
    "--density", default=0.2, type=float, help="density of perturbation"
)
parser.add_argument(
...
with open(
    f"../perturbed_datasets/{DATA_SET}/{PERTURBATION}/"
    f"{PERTURBATION}_{DISTRIBUTION}_{DENSITY}_train.csv",
    "w",
    newline="",
) as file:
...
with open(
    f"../perturbed_datasets/{DATA_SET}/{PERTURBATION}/"
    f"{PERTURBATION}_{DISTRIBUTION}_{DENSITY}_test.csv",
    "w",
    newline="",
) as file:
    writer = csv.writer(file)
