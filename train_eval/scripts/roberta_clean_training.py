...
tokenized_train_set = tokenizer(train_text, truncation=True, padding=True, return_tensors="pt")
...
tokenized_test_set = tokenizer(val_text + test_text, truncation=True, padding=True, return_tensors="pt")
