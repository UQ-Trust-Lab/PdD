...
import torch
from new_version.perturbation import Generator, DELETION_DICT, HOMOGLYPHS_DICT, INVISIBLE_UNICODE_DICT, \
    KEYBOARD_TYPO_ADVANCED_DICT
...
parser.add_argument('--dataset', default="snli", type=str,
...
# Randomly sample 9k data from the training set and 2k data from test set to match the dataset size of rotten tomatoes
